...
{:else}
  <div class="glass-panel-fixed p-8 rounded-xl max-w-2xl mx-auto">
      ...
      <p class="text-slate-300 mb-6">{assessmentData.description || 'Welcome.'}</p>
      ...
      <div class="mt-8">
          <button onclick={startAssessment} class="w-full px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-bold">
              Start Assessment
          </button>
      </div>
  </div>
