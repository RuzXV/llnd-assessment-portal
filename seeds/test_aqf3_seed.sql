-- Complete AQF3 Health Quiz Seed for Testing
-- Run with: npx wrangler d1 execute llnd-core-db --file=seeds/test_aqf3_seed.sql --remote

-- Step 1: Create the Product (using assessment_products table)
INSERT OR REPLACE INTO assessment_products (product_id, name, aqf_level, stream, active, version)
VALUES (
    'aqf3-health',
    'AQF 3 Universal LLND Assessment - Health & Community Services',
    '3',
...
-- Step 2: Create the Product Version
INSERT OR REPLACE INTO assessment_versions (version_id, product_id, version_number, is_active, description)
VALUES (
    'ver-aqf3-health-v1',
    'aqf3-health',
    '1.0',
    1,
    'Pilot version for Certificate III Health & Community Services - 28 questions'
);

-- Step 3: Add Seats for Testing (10 seats)
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r1-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Medication charts', 'Medication charts',
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 2, 'Comprehension', 'core', 1,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r1-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 2, 'Comprehension', 'core', 2,
    'Notice to Staff
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r2-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Procedure', 'core', 3,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r2-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Procedure', 'core', 4,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r3-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Slipping', 'Slipping',
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Risk Identification', 'core', 5,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r3-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'To ensure timely action is taken', 'To ensure timely action is taken',
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Policy Understanding', 'core', 6,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r-s1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Check how the client is feeling and confirm with the supervisor', 'Check how the client is feeling and confirm with the supervisor',
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Critical Analysis', 'stretch', 7,
    'Text A – Care Plan:
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-r-s2', 'aqf3-health', 'ver-aqf3-health-v1',
    'What problem is this instruction trying to prevent?',
    'What problem is this instruction trying to prevent?',
    'multiple_choice', 'multiple_choice', 'mcq',
    '["Client boredom", "Missed meal times", "Delays in getting help", "Equipment loss"]',
    'Delays in getting help', 'Delays in getting help',
    1.0, 1.0, 3.625,
    'Reading', 'Reading', 3, 'Inference', 'stretch', 8,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-w1-1', 'aqf3-health', 'ver-aqf3-health-v1',
    'Write 1–2 sentences explaining why a client activity started late today.',
    'Write 1–2 sentences explaining why a client activity started late today.',
    'short_answer', 'short_answer', 'short_text',
    NULL,
    NULL, NULL,
    3.0, 3.0, 3.5,
    'Writing', 'Writing', 2, 'Explanation', 'core', 9,
    NULL
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-w1-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    NULL, NULL,
    3.0, 3.0, 3.5,
    'Writing', 'Writing', 2, 'Confirmation', 'core', 10,
    NULL
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-w-s1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    NULL, NULL,
    3.0, 3.0, 3.5,
    'Writing', 'Writing', 3, 'Cause and Effect', 'stretch', 11,
    NULL
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-w2-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    NULL, NULL,
    3.0, 3.0, 3.5,
    'Writing', 'Writing', 3, 'Request', 'core', 12,
    NULL
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-n1-1', 'aqf3-health', 'ver-aqf3-health-v1',
    'How long is the shift? (Enter answer in hours, e.g., 7.5)',
    'How long is the shift? (Enter answer in hours, e.g., 7.5)',
    'short_answer', 'short_answer', 'numeric',
    NULL,
    '7.5', '7.5',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 2, 'Time Calculation', 'core', 13,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-n1-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '7', '7',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 2, 'Arithmetic', 'core', 14,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-n1-3', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '$51.00', '$51.00',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Cost Calculation', 'core', 15,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-n2-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '10:00 am', '10:00 am',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Time Interpretation', 'core', 16,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-n-s1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '25%', '25%',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Percentage', 'stretch', 17,
    'Out of 20 clients, 5 require additional assistance.'
);

-- N-S2 - Table + Rule (ACSF 3, Stretch)
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text, context_table)
VALUES (
    'aqf3-n-s2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '50', '50',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Table Analysis', 'stretch', 18,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text, context_table)
VALUES (
    'aqf3-n3-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Wednesday', 'Wednesday',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Data Interpretation', 'core', 19,
    NULL,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text, context_table)
VALUES (
    'aqf3-n3-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Incidents varied across the week', 'Incidents varied across the week',
    1.0, 1.0, 3.625,
    'Numeracy', 'Numeracy', 3, 'Trend Analysis', 'core', 20,
    NULL,
    '{"headers": ["Day", "Incidents"], "rows": [["Monday", "2"], ["Tuesday", "1"], ["Wednesday", "3"], ["Thursday", "1"], ["Friday", "0"]]}'
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-o1-1', 'aqf3-health', 'ver-aqf3-health-v1',
    'What must be done before informing the supervisor?',
    'What must be done before informing the supervisor?',
    'multiple_choice', 'multiple_choice', 'mcq',
    '["Assist with lunch", "Prepare medication", "Clean the room", "Update records"]',
    'Assist with lunch', 'Assist with lunch',
    1.0, 1.0, 3.5,
    'Oral', 'Oral', 2, 'Following Instructions', 'core', 21,
    'Transcript:
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-o1-2', 'aqf3-health', 'ver-aqf3-health-v1',
    'What is the key message?',
    'What is the key message?',
    'multiple_choice', 'multiple_choice', 'mcq',
    '["Follow the plan without questions", "Ask for clarification if unsure", "Work independently", "Finish quickly"]',
    'Ask for clarification if unsure', 'Ask for clarification if unsure',
    1.0, 1.0, 3.5,
    'Oral', 'Oral', 3, 'Key Message', 'core', 22,
    'Transcript:
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-o-s1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    1.0, 1.0, 3.5,
    'Oral', 'Oral', 3, 'Appropriate Response', 'stretch', 23,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-o-s2', 'aqf3-health', 'ver-aqf3-health-v1',
    'What should you do?',
    'What should you do?',
    'multiple_choice', 'multiple_choice', 'mcq',
    ...
    'Finish current task and respond as soon as safe to do so', 'Finish current task and respond as soon as safe to do so',
    1.0, 1.0, 3.5,
    'Oral', 'Oral', 3, 'Prioritisation', 'stretch', 24,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-d1-1', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    1.0, 1.0, 3.5,
    'Digital', 'Digital', 2, 'Form Completion', 'core', 25,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-d1-2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    '.pdf', '.pdf',
    1.0, 1.0, 3.5,
    'Digital', 'Digital', 2, 'File Types', 'core', 26,
    NULL
);
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-d-s1', 'aqf3-health', 'ver-aqf3-health-v1',
    'What should you do?',
    'What should you do?',
    'multiple_choice', 'multiple_choice', 'mcq',
    '["Leave the error", "Delete the record", "Edit, save, and submit the corrected note", "Log out"]',
    'Edit, save, and submit the corrected note', 'Edit, save, and submit the corrected note',
    1.0, 1.0, 3.5,
    'Digital', 'Digital', 3, 'Error Correction', 'stretch', 27,
...
INSERT OR REPLACE INTO questions (question_id, product_id, version_id, question_text, text, question_type, type, response_type, options, correct_answer, correct_response, points_possible, max_score, weight, acsf_domain, domain, acsf_level, acsf_skill, difficulty_tag, order_index, context_text)
VALUES (
    'aqf3-d-s2', 'aqf3-health', 'ver-aqf3-health-v1',
    ...
    'Using strong passwords and logging out', 'Using strong passwords and logging out',
    1.0, 1.0, 3.5,
    'Digital', 'Digital', 3, 'Digital Safety', 'core', 28,
    NULL
);
